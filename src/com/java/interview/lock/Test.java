package com.java.interview.lock;
...
public class Test {
    ...
    /** * 获取线程的变量副本，如果不覆盖initialValue方法，第一次get将返回null,故需要创建一个DateFormat，放入threadLocal中 * @return */
    ...
    public static class MyRunnable implements Runnable {
        private Test dateFormatDemo;
        public MyRunnable(Test dateFormatDemo) {
